                <footer>
                  ...
                  <nav>
                      <ul>
                         ...
                         <li>
                            <a href="diving.php"><span>Diving in Kosrae</span></a>
                         </li>
                         <li>
                            <a href="sites.php"><span>Dive Sites</span></a>
                         </li>
                         <li>
                            <a href="contact.php"><span>Contact Us</span></a>
                         </li>
                         <li class="bookfooter">
                            <a href="http://kosraenautilus.com/">Kosrae Nautilus Resort</a>  
                         </li>
                        </ul>
